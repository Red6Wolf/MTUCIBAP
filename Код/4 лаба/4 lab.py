...
ssh_conn(ip_address='10.0.0.1', username='user1', password='password123') 
ssh_conn('172.16.0.1', password='secure_pass', username='root') 
...
print(generate_ip(octets='172.16.0')) 
